...
export const tablesInitialState = {
  entries: [
    ...
    },
    {
      ...
      color: "lazure",
      description:
        "Обеденный стол с инкрустированными кристаллами, создающими эффект звездного неба",
    ...
    },
    {
      ...
      color: "blue",
      description:
        "Деревянный стол с глубокими, темными оттенками, напоминающими ночное небо",
    ...
    },
    {
      ...
      color: "lazure",
      description:
        "Стол с мраморной столешницей и ножками, напоминающими ветви древних деревьев",
    ...
    },
    {
      ...
      color: "blue",
      description:
        "Чайный столик с эффектом инея и фрагментами льда, создающими холодный блеск",
    ...
    },
    {
      ...
      color: "orange",
      description:
        "Стол с потайными ящиками и магическими рунами на поверхности",
    ...
    },
    {
      ...
      color: "lazure",
      description:
        "Легендарный стол, покрытый золотыми звездными узорами и светящимися элементами",
    ...
    },
    {
      ...
      color: "orange",
      description:
        "Стол для работы с древними символами и резьбой, вдохновленной природой",
    ...
    },
    {
      ...
      color: "lavender",
      description:
        "Стол с цветочными узорами и инкрустациями, создающими эффект вечернего заката",
    ...
    },
    {
      ...
      color: "pink",
      description:
        "Стол для книг с полочками и вырезами в форме листьев и цветков",
