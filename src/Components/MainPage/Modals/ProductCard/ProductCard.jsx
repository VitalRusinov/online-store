...
import {translateProp, translateColor} from '../../../../utils/translate';
...
const ProductCard = ({modalInfo, closeModal}) => {
  ...
  const {id, image, name, article, color, description, designer, size, price} = payload;
