...
const CategoryCard = ({ category, activeCategory, setActiveCategory }) => {
  ...
  return (
    <div className={categoryCardClasses} onClick={handleClick}>
      <svg
        viewBox="0 0 388 462"
        fill="none"
      ...
      <button className={styles.cat_button}>
        ...
        >
          <g clipPath="url(#clip0_105_578)">
            <path
              d="M27.2734 22.6667C26.2134 22.6667 24.6306 23.7051 23.302 24.7562C21.5877 26.1077 20.092 27.7227 18.9506 29.5743C18.0949 30.9627 17.2734 32.6457 17.2734 34M17.2734 34C17.2734 32.6457 16.452 30.9612 15.5963 29.5743C14.4534 27.7227 12.9577 26.1077 11.2463 24.7562C9.9163 23.7051 8.33058 22.6667 7.27344 22.6667M17.2734 34L17.2734 -1.11265e-06"
              strokeWidth="2"
              strokeLinecap="round"
            />
          </g>
          <defs>
            <clipPath id="clip0_105_578">
              <rect
                ...
                height="34"
                fill="white"
                transform="translate(34.2734 34) rotate(-180)"
              />
            </clipPath>
          </defs>
        </svg>
      ...
      <div className={styles.inscription}>
        ...
        >
          <defs>
            <path
              id="ellipsePath"
              d="M 194.5,231 m -169.5,0 a 169.5,206 0 1,1 339,0 a 169.5,206 0 1,1 -339,0"
            />
          </defs>
          <g transform="rotate(-223 194.5 231)">
            <text fontWeight="500" letterSpacing="0.08em">
